...
public class RecommendActivity extends BaseActivity {
    ...
    protected void onActivityCreate(Bundle savedInstanceState) {
        ...
        CommonGoodsResponse commonGoodsResponse = JsonUtils.jsonStrToObject(JsonConstant.RECOMMEND_JSON, CommonGoodsResponse.class);
        ...
        mainGoodsAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                DetailActivity.startDetailActivity(RecommendActivity.this, itemModel.goods_id);
            }
        });
    }
