...
public class RankingListActivity extends BaseActivity {
    ...
    protected void onActivityCreate(Bundle savedInstanceState) {
        ...
        mainGoodsAdapter = new MainGoodsAdapter(R.layout.item_grid_goods_layout, commonGoodsResponse.data, true);
        ...
        mainGoodsAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                DetailActivity.startDetailActivity(RankingListActivity.this, itemModel.goods_id);
            }
        });
    }
